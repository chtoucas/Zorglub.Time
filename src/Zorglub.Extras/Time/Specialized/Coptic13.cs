...
namespace Zorglub.Time.Specialized
{
    ...
    /// <summary>
    /// Represents the common adjusters for <typeparamref name="Coptic13Date"/>.
    /// </summary>
    ...
    public partial struct Coptic13Date // Conversions, adjustments...
    {
        ...
        /// </summary>
        [Pure]
        public static Coptic13Date Today() => new(DayNumber.Today() - s_Epoch);

        #endregion
        #region Conversions

        [Pure]
        static Coptic13Date IFixedDay<Coptic13Date>.FromDayNumber(DayNumber dayNumber) =>
            new(dayNumber);
