...
namespace Zorglub.Time.Specialized
{
    ...
    public sealed class Ethiopic13Calendar :
        MinMaxYearCalendar<Ethiopic13Date>,
        IRegularFeaturette,
    ...
    /// </summary>
    public sealed class Ethiopic13Adjusters : MinMaxYearDateAdjusters<Ethiopic13Date>
    {
        /// <summary>
        ...
        internal Ethiopic13Adjusters(Ethiopic13Calendar calendar) : base(calendar) { }
    ...
    public partial struct Ethiopic13Date // Conversions, adjustments...
    {
        ...
        [Pure]
        static Ethiopic13Date IFixedDay<Ethiopic13Date>.FromDayNumber(DayNumber dayNumber) =>
            new(dayNumber);
