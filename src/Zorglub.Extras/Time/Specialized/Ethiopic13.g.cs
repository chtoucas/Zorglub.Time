...
public sealed class Ethiopic13Clock
{
    ...
    /// <summary>Obtains an instance of the <see cref="Ethiopic13Clock"/> class for the specified
    /// clock.</summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is null.</exception>
    [Pure]
    public static Ethiopic13Clock GetClock(IClock clock) => new(clock);

    /// <summary>Obtains a <see cref="Ethiopic13Date"/> value representing the current
    /// date.</summary>
    [Pure]
    ...
    IAdjustable<Ethiopic13Date>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="Ethiopic13Date"/> struct.</summary>
