...
namespace Zorglub.Time.Specialized
{
    ...
    public sealed class Armenian13Calendar :
        MinMaxYearCalendar<Armenian13Date>,
        IRegularFeaturette,
    ...
    /// <summary>
    /// Represents the common adjusters for <see cref="Armenian13Date"/>.
    /// </summary>
        ...
        IEpagomenalDay
    {
        ...
        /// <para>This is also the default value for <see cref="Armenian13Date"/>.</para>
        /// <para>This field is read-only.</para>
        /// </summary>
