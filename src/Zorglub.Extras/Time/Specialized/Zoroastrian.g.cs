...
public sealed partial class ZoroastrianClock
{
    ...
    /// <summary>Obtains an instance of the <see cref="ZoroastrianClock"/> class for the specified
    /// clock.</summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is null.</exception>
    [Pure]
    public static ZoroastrianClock GetClock(IClock clock) => new(clock);

    /// <summary>Obtains a <see cref="ZoroastrianDate"/> value representing the current
    /// date.</summary>
    [Pure]
    ...
    IAdjustable<ZoroastrianDate>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ZoroastrianDate"/> struct.</summary>
