...
public sealed class CopticClock
{
    ...
    /// <summary>Obtains an instance of the <see cref="CopticClock"/> class for the specified
    /// clock.</summary>
    /// <exception cref="ArgumentNullException"><paramref name="clock"/> is null.</exception>
    [Pure]
    public static CopticClock GetClock(IClock clock) => new(clock);

    /// <summary>Obtains a <see cref="CopticDate"/> value representing the current
    /// date.</summary>
    [Pure]
...
public partial struct CopticDate :
    ...
    IAdjustable<CopticDate>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="CopticDate"/> struct.</summary>
