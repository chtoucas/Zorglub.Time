...
/// <summary>Provides static helpers and extension methods for <see cref="Range{T}"/>.
...
public partial class Range // Factories
{
    ...
    /// <para>This factory method does NOT validate its parameters.</para></summary>
    [Pure]
    ...
    /// <summary>Creates a new instance of the <see cref="Range{T}"/> struct representing the
    /// degenerate range [<paramref name="value"/>].</summary>
    [Pure]
    ...
    /// <summary>Creates a new instance of the <see cref="Range{T}"/> struct representing the range
    /// [<see cref="IMinMaxValue{T}.MinValue"/>..<see cref="IMinMaxValue{T}.MaxValue"/>].</summary>
    [Pure]
    ...
    /// <summary>Creates a new instance of the <see cref="Range{T}"/> struct representing the range
    /// [<paramref name="min"/>..<see cref="IMinMaxValue{T}.MaxValue"/>].</summary>
    [Pure]
    ...
    /// <summary>Creates a new instance of the <see cref="Range{T}"/> struct representing the range
    /// [<see cref="IMinMaxValue{T}.MinValue"/>..<paramref name="max"/>].</summary>
    [Pure]
