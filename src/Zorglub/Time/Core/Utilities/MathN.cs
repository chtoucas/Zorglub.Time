...
namespace Zorglub.Time.Core.Utilities
{
    ...
    {
        /// <summary>
        /// Calculates the Euclidian quotient of a positive 32-bit signed integer by a strictly
        /// positive 32-bit signed integer and also returns the remainder in an output parameter.
        /// <para>When dividing by a constant, performance-wise, it might be better to use the plain
        /// C# operators / and %.</para>
        ...
        /// <summary>
        /// Calculates the adjusted Euclidian quotient of a positive 32-bit signed integer by a
        ...
        /// <summary>
        /// Calculates the adjusted remainder of the Euclidian division of a positive 32-bit signed
        ...
        /// <summary>
        /// Calculates the Euclidian quotient augmented by 1 of a positive 32-bit signed integer by
        /// a strictly positive 32-bit signed integer and also returns the remainder augmented by 1
