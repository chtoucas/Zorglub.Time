...
namespace Zorglub.Time.Core.Utilities
{
    ...
    internal partial class MathZ // Divide
    {
        ...
        /// <summary>
        /// Calculates the Euclidian quotient of a 32-bit signed integer by a
        /// strictly positive 32-bit signed integer and also returns the
    ...
    internal partial class MathZ // Divide (long)
    {
        ...
        /// <summary>
        /// Calculates the Euclidian quotient of a 64-bit signed integer by a
        /// strictly positive 64-bit signed and also returns the remainder in
        /// an output parameter.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
    ...
    {
        /// <summary>
        /// Calculates the remainder of the Euclidian division of a 32-bit
        /// signed integer by a strictly positive 32-bit signed integer.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
        /// <para>The remainder is in the range from 0 to
        /// (<paramref name="n"/> - 1), both included.</para>
        /// </remarks>
        [Pure]
        ...
        /// returns the quotient in an output parameter.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
        /// <para>This is equivalent to <see cref="Divide(int, int, out int)"/>
        /// but sometimes it just feels more natural to use a modulo.</para>
        /// </remarks>
        [Pure]
        // CIL code size = 31 bytes <= 32 bytes.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    {
        /// <summary>
        /// Calculates the remainder of the Euclidian division of a 64-bit
    ...
    {
        /// <summary>
        /// Calculates the adjusted Euclidian quotient of a 32-bit signed
        ...
        /// <summary>
        /// Calculates the adjusted Euclidian quotient of a 32-bit signed
        /// integer by a strictly positive 32-bit signed integer and also
        /// returns the adjusted remainder in an output parameter.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
        /// <para>The adjusted remainder <paramref name="r"/> is in the range
        /// from 1 to <paramref name="n"/>, both included.</para>
        /// </remarks>
        [Pure]
        // CIL code size = 31 bytes <= 32 bytes.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal partial class MathZ // AdjustedModulo
    {
        ...
        /// <summary>
        /// Calculates the adjusted remainder of the Euclidian division of a
    ...
    internal partial class MathZ // AdjustedModulo (long)
    {
        /// <summary>
        /// Calculates the adjusted remainder of the Euclidian division of a
        /// 64-bit signed integer by a strictly positive 64-bit signed integer.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
        /// <para>The adjusted remainder is in the range from 1 to
    ...
    internal partial class MathZ // AugmentedDivide
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>The augmented remainder <paramref name="r"/> is in the range
        /// from 1 to (<paramref name="n"/>), both included.</para>
        /// </remarks>
        [Pure]
