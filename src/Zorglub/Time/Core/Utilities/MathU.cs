...
{
    /// <summary>
    /// Provides static methods for common unsigned mathematical operations.
    ...
    {
        /// <summary>
        /// Calculates the Euclidian quotient of a 32-bit unsigned integer by a
        /// non-zero 32-bit unsigned integer and also returns the remainder in
        /// an output parameter.
        /// <para>When dividing by a constant, performance-wise, it might be
        /// better to use the plain C# operators / and %.</para>
        ...
        /// <summary>
        /// Calculates the adjusted Euclidian quotient of a 32-bit unsigned
        ...
        /// 32-bit unsigned integer by a non-zero 32-bit unsigned integer.
        /// <para>This method does NOT validate its parameters.</para>
        /// </summary>
        /// <remarks>
