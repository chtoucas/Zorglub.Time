...
/// <summary>Represents a validator for a range of months, that is the range of supported numbers of
/// consecutive months from the epoch.
/// <para>This class cannot be inherited.</para></summary>
public sealed class MonthsValidator : IRangeValidator<int>
{
    /// <summary>Initializes a new instance of the <see cref="MonthsValidator"/> class.</summary>
    ...
    /// <summary>Gets the range of supported numbers of consecutive months from the epoch.</summary>
    public Range<int> Range { get; }

    /// <summary>Gets the minimum number of consecutive months from the epoch.</summary>
    public int MinMonthsSinceEpoch { get; }

    /// <summary>Gets the maximum number of consecutive months from the epoch.</summary>
    ...
    /// <exception cref="OverflowException"><paramref name="monthsSinceEpoch"/> is outside the range
    ...
    /// <exception cref="OverflowException"><paramref name="monthsSinceEpoch"/> is greater than the
    ...
    /// than the lower bound of the range of supported values or not.</summary>
