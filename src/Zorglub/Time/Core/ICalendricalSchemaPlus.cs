...
/// <summary>Defines an extended calendrical schema.</summary>
public interface ICalendricalSchemaPlus : ICalendricalSchema
{
    /// <summary>Obtains the number of whole days remaining after the specified month and until the
    ...
    /// <summary>Obtains the number of whole days remaining after the specified date and until the
    /// end of the year.</summary>
    ...
    /// <summary>Obtains the number of whole days elapsed since the start of the month and before
    /// the specified day.</summary>
