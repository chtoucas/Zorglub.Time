...
namespace Zorglub.Time.Core
{
    ...
    /// <summary>
    /// Defines a <i>set membership relation</i> with an object of type <typeparamref name="T"/>.
    /// </summary>
    /// <typeparam name="T">The type of object to test for set membership.</typeparam>
    public interface ISetMembership<in T>
    {
        /// <summary>
        /// Returns true if this set contains the specified value; otherwise returns false.
        /// </summary>
        [Pure] bool Contains(T value);
    }

    /// <summary>
    /// Defines a <i>set equality relation</i> with an object of type
    ...
    /// <summary>
    /// Defines a <i>set inclusion relation</i> with an object of type
    /// <typeparamref name="TOther"/>.
    /// </summary>
    ...
    /// <summary>
    /// Defines a <i>set equality relation</i> and a <i>set inclusion relation</i> (strict and large)
    /// with an object of type <typeparamref name="TOther"/>.
    /// </summary>
