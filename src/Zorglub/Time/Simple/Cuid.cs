...
namespace Zorglub.Time.Simple
{
    ...
    internal enum Cuid : byte
    {
        ...
        /// <summary>
        /// The identifier of the Coptic calendar.
        /// </summary>
        Coptic = CalendarId.Coptic,

        /// <summary>
        /// The identifier of the Ethiopic calendar.
        /// </summary>
        Ethiopic = CalendarId.Ethiopic,

        /// <summary>
        /// The identifier of the Tabular Islamic calendar.
        /// </summary>
        TabularIslamic = CalendarId.TabularIslamic,

        /// <summary>
        /// The identifier of the Zoroastrian calendar.
        /// </summary>
        ...
        /// <summary>
        /// The maximum ID for a system calendar.
        /// </summary>
        MaxSystem = Zoroastrian,

        /// <summary>
        /// The minimum ID for a user-defined calendar.
        /// </summary>
        // NB: we could use MaxSystem + 1, but I prefer to be conservative.
        MinUser = 64,

        /// <summary>
        /// The absolute maximum ID for a calendar.
        /// </summary>
    ...
    /// <summary>
    /// Provides extension methods for <see cref="Cuid"/>.
    /// <para>This class cannot be inherited.</para>
    /// </summary>
    internal static class CuidExtensions
    {
        /// <summary>
        /// Returns true if the specified ID is fixed; otherwise returns false.
        /// <para>An ID is fixed iff it's the ID of a system calendar.</para>
        /// </summary>
        [Pure]
