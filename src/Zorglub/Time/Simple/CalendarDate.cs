...
namespace Zorglub.Time.Simple
{
    ...
    public partial struct CalendarDate // Factories, conversions, adjustments, etc.
    {
        ...
        // CalendarYear
        //
        // To enumerates the days in a specified year, see DateRange.Create(year).
        ...
        // Factories (month)
        //
        // To enumerates the days in a specified month, see DateRange.FromMonth(month).
        ...
        /// <summary>
        /// Obtains a new <see cref="CalendarDate"/> instance in the Gregorian calendar from the
        ...
        public CalendarDate Nearest(DayOfWeek dayOfWeek)
        {
            ...
            return chr.GetCalendarDateOn(nearest);
        }
