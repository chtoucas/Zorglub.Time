...
/// <summary>Defines the (origin of the) different styles of numbering days and common calendar
/// epochs.</summary>
...
public partial class DayZero //
{
    ...
    /// of the Gregorian calendar.</summary>
    /// <remarks>
    ...
    /// of the Julian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the day before <see cref="NewStyle"/>.</summary>
...
{
    /// <summary>Gets the epoch of the Julian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Gregorian calendar.</summary>
    /// <remarks>
...
public partial class DayZero //
{
    /// <summary>Gets the epoch of the Holocene calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Egyptian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the day before the Gregorian epoch.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Ethiopic calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Coptic calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Armenian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Persian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Tabular Islamic calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Zoroastrian calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Positivist calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the French Republican calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the Minguo calendar, aka the Republic of China calendar.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the epoch of the "Tropicália" calendar.</summary>
    /// <remarks>
