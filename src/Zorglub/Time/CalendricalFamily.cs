...
public enum CalendricalFamily
{
    ...
    /// <summary>The calendar cycle is based upon the Annus Vagus.</summary>
    /// <remarks>
    ...
    /// separated from the solar family.</para>
    /// </remarks>
    AnnusVagus,

    /// <summary>The calendar cycle is based upon the position of Earth on its revolution around the
    /// Sun.</summary>
    /// <remarks>A common year is 365 days long and a leap year is 366 days long.</remarks>
    Solar,

    /// <summary>The calendar cycle is based upon the phases of the Moon.</summary>
    /// <remarks>A common year is 354 days long and a leap year is 355 days long.</remarks>
    Lunar,
