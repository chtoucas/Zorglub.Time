...
{
    /// <summary>Determines whether the current instance is an epagomenal day or not, and also
    /// returns the epagomenal number of the day in an output parameter, zero if the date is not an
