...
namespace Zorglub.Time.Hemerology.Scopes
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>This is the scope used by <see cref="Simple.Calendar"/> in the Gregorian and Julian
    /// cases.</para>
    /// </remarks>
    public sealed class ProlepticScope : CalendarScope
    {
        /// <summary>
        ...
        /// </summary>
        internal static ISupportedValues<int> SupportedYearsImpl { get; } = new SupportedYears_();
