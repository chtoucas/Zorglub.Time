...
namespace Zorglub.Time.Hemerology.Scopes
{
    ...
    /// </remarks>
    public sealed class StandardShortScope : ICalendarScope
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardShortScope"/> class with the
        /// specified schema and epoch.
        /// </summary>
        /// <exception cref="ArgumentNullException"><paramref name="schema"/> is null.</exception>
        /// <exception cref="ArgumentException">The range of supported years by
        /// <paramref name="schema"/> does not contain the interval [1..9999].</exception>
        public StandardShortScope(ICalendricalSchema schema, DayNumber epoch)
        {
