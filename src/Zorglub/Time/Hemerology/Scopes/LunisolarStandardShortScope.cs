...
namespace Zorglub.Time.Hemerology.Scopes
{
    ...
    /// <summary>
    /// Represents the short scope of a schema with profile <see cref="CalendricalProfile.Lunisolar"/>.
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LunisolarStandardShortScope"/> class with the
            ...
            : base(schema, epoch)
        {
            ...
            if (schema.Profile != CalendricalProfile.Lunisolar)
            {
        ...
        public override void ValidateYearMonthDay(int year, int month, int day, string? paramName = null)
        {
            ...
            if (day < 1
                || (day > Lunisolar.MinDaysInMonth && day > Schema.CountDaysInMonth(year, month)))
            {
