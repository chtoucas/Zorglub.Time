...
namespace Zorglub.Time.Hemerology
{
    ...
    /// <summary>
    /// Provides static methods for common operations related to decades, centuries, millennia and
    /// eras.
    ...
    public partial class YearNumbering // Decades, centuries, millennia; default (chronological) numbering.
    {
        ...
        /// <summary>
        /// Obtains the decade of the century from the specified year and also returns the century
        /// and the year of the decade in output parameters.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the decade from the specified year and also returns the year of the decade in an
        /// output parameter.
        /// <para>The first decade starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified decade and year of the decade.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the century from the specified year and also returns the year of the century in
        /// an output parameter.
        /// <para>The first century starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified century and year of the century.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the millennium from the specified year and also returns the year of the
        /// millennium in an output parameter.
        /// <para>The first millennium starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified millennium and year of the millennium.
        /// </summary>
        [Pure]
    ...
    public partial class YearNumbering // Decades, centuries, millennia; ISO numbering.
    {
        ...
        /// <summary>
        /// Obtains the ISO decade of the century from the specified year and also returns the
        /// century and the year of the decade in output
        /// parameters.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the ISO decade from the specified year and also returns the year of the decade
        /// in an output parameter.
        /// <para>The first ISO decade starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified ISO decade and year of the decade.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the ISO century from the specified year and also returns the year of the century
        /// in an output parameter.
        /// <para>The first ISO century starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified ISO century and year of the century.
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the ISO millennium from the specified year and also returns the year of the
        /// millennium in an output parameter.
        /// <para>The first ISO millennium starts at the onset of year 0.</para>
        /// </summary>
        [Pure]
        ...
        /// <summary>
        /// Obtains the year from the specified ISO millennium and year of the millennium.
        /// </summary>
        [Pure]
