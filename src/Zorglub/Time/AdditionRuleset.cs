...
{
    /// <summary>Initializes a new instance of the <see cref="AdditionRuleset"/> struct.</summary>
    /// <exception cref="AoorException">One of the parameters is outside the range of its valid
    /// values.</exception>
    public AdditionRuleset(AdditionRule dateRule, AdditionRule ordinalRule, AdditionRule monthRule)
    {
    ...
    /// <summary>Gets the strategy employed to resolve ambiguities when adding a number of months or
    /// years to a date.</summary>
    public AdditionRule DateRule { get; }

    /// <summary>Gets the strategy employed to resolve ambiguities when adding a number of years to
    /// an ordinal date.</summary>
