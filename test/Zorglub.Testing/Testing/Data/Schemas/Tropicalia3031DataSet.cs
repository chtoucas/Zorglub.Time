...
public partial class Tropicalia3031DataSet // Infos
{
    ...
    public override DataGroup<MonthInfo> MonthInfoData { get; } = new()
    {
        ...
        new(CommonYear, 2, 31, 30, 304, false),
        new(CommonYear, 3, 30, 61, 274, false),
        new(CommonYear, 4, 31, 91, 243, false),
        new(CommonYear, 5, 30, 122, 213, false),
        new(CommonYear, 6, 31, 152, 182, false),
        new(CommonYear, 7, 30, 183, 152, false),
        new(CommonYear, 8, 31, 213, 121, false),
        new(CommonYear, 9, 30, 244, 91, false),
        new(CommonYear, 10, 31, 274, 60, false),
        new(CommonYear, 11, 30, 305, 30, false),
        new(CommonYear, 12, 30, 335, 0, false),
        // Leap year.
        new(LeapYear, 1, 30, 0, 336, false),
        new(LeapYear, 2, 31, 30, 305, false),
        ...
        new(LeapYear, 7, 30, 183, 153, false),
