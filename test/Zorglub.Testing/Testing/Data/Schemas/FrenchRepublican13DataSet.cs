...
public sealed partial class FrenchRepublican13DataSet :
    CalendricalDataSet, IEpagomenalDataSet, ISingleton<FrenchRepublican13DataSet>
{
...
public partial class FrenchRepublican13DataSet // Infos
{
    ...
    public override TheoryData<DaysSinceEpochInfo> DaysSinceEpochInfoData =>
        _daysSinceEpochInfoData ??=
            TheoryDataOfDaysSinceEpochInfo.FromDaysSinceRataDieInfos(DaysSinceRataDieInfos, CalendarEpoch.FrenchRepublican);
    ...
    public override TheoryData<MonthInfo> MonthInfoData => new()
    {
        ...
        new(CommonCentury, 12, 30, 330, false),
        new(CommonCentury, 13, 5, 360, false),
        ...
        new(LeapCentury, 12, 30, 330, false),
