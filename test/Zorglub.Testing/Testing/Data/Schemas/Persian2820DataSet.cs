...
public sealed partial class Persian2820DataSet : CalendricalDataSet, ISingleton<Persian2820DataSet>
{
    ...
    public override TheoryData<YemodaAnd<int>> DaysInYearAfterDateData =>
        GetDaysInYearAfterDateData(new Persian2820Schema());
    public override TheoryData<YemodaAnd<int>> DaysInMonthAfterDateData =>
        GetDaysInMonthAfterDateData(new Persian2820Schema());
}
...
public partial class Persian2820DataSet // Infos
{
    ...
    public override TheoryData<DaysSinceEpochInfo> DaysSinceEpochInfoData =>
        _daysSinceEpochInfoData ??= CalCal.ConvertRataDieToDaysSinceEpochInfo(RataDieInfos, CalendarEpoch.Persian);
    ...
    internal static List<(int RataDie, int Year, int Month, int Day)> RataDieInfos { get; } = new()
    {
        ...
        // See PersianData.GetYear().
        // First 2820-year cycle: years 1-474.
        (400_020, 474, 12, 30),
        // Second cycle.
        (400_021, 475, 1, 1),
        (1_430_003, 3294, 12, 30),
        // Third cycle.
        (1_430_004, 3295, 1, 1),
        (2_459_986, 6114, 12, 30),
