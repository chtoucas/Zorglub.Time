...
public sealed partial class Tropicalia3130DataSet : TropicalistaDataSet, ISingleton<Tropicalia3130DataSet>
{
    ...
    public static Tropicalia3130DataSet Instance => Singleton.Instance;

    private static class Singleton
    {
        internal static readonly Tropicalia3130DataSet Instance = new();
        static Singleton() { }
    }
}
...
public partial class Tropicalia3130DataSet // Infos
{
    ...
    public override DataGroup<MonthInfo> MonthInfoData { get; } = new()
    {
        ...
        new(CommonYear, 3, 31, 61, 273, false),
        new(CommonYear, 4, 30, 92, 243, false),
        new(CommonYear, 5, 31, 122, 212, false),
        new(CommonYear, 6, 30, 153, 182, false),
        new(CommonYear, 7, 31, 183, 151, false),
        new(CommonYear, 8, 30, 214, 121, false),
        new(CommonYear, 9, 31, 244, 90, false),
        new(CommonYear, 10, 30, 275, 60, false),
        new(CommonYear, 11, 31, 305, 29, false),
        new(CommonYear, 12, 29, 336, 0, false),
        // Leap year.
        new(LeapYear, 1, 31, 0, 335, false),
        new(LeapYear, 2, 30, 31, 305, false),
        new(LeapYear, 3, 31, 61, 274, false),
        new(LeapYear, 4, 30, 92, 244, false),
        new(LeapYear, 5, 31, 122, 213, false),
        new(LeapYear, 6, 30, 153, 183, false),
        new(LeapYear, 7, 31, 183, 152, false),
        new(LeapYear, 8, 30, 214, 122, false),
        new(LeapYear, 9, 31, 244, 91, false),
        new(LeapYear, 10, 30, 275, 61, false),
        new(LeapYear, 11, 31, 305, 30, false),
