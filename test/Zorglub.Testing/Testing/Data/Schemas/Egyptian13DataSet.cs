    ...
    SchemaDataSet, IEpagomenalDataSet, ISingleton<Egyptian13DataSet>
{
    ...
    public static Egyptian13DataSet Instance => Singleton.Instance;

    private static class Singleton
    {
        internal static readonly Egyptian13DataSet Instance = new();
        static Singleton() { }
    }
}
...
public partial class Egyptian13DataSet // Infos
{
    ...
    public override DataGroup<MonthInfo> MonthInfoData { get; } = new()
    {
        ...
        new(SampleYear, 12, 30, 330, 5, false),
        new(SampleYear, 13, 5, 360, 0, false),
    };
    ...
    internal static IEnumerable<DaysSinceRataDieInfo> DaysSinceRataDieInfos
    {
        get
        {
            ...
            // Epagomenal days.
            yield return new(613_428, 2428, 13, 1);
            yield return new(613_429, 2428, 13, 2);
            yield return new(613_430, 2428, 13, 3);
            yield return new(613_431, 2428, 13, 4);
            yield return new(613_432, 2428, 13, 5);
