...
/// <para>See also <see cref="IDateFacts{TDate, TDataSet}"/>.</para>
/// </summary>
public abstract partial class IDateQuickFacts<TDate, TDataSet> : IDateableFacts<TDate, TDataSet>
    where TDate : struct, IDate<TDate>
    where TDataSet : ICalendarDataSet, ISingleton<TDataSet>
{
    protected IDateQuickFacts(Range<int> supportedYears, Range<DayNumber> domain)
    {
        Domain = domain;
...
public partial class IDateQuickFacts<TDate, TDataSet> // Prelude
{
...
public partial class IDateQuickFacts<TDate, TDataSet> // Conversions
{
    [Fact]
...
public partial class IDateQuickFacts<TDate, TDataSet> // Adjust the day of the week
{
    #region Arg check
...
public partial class IDateQuickFacts<TDate, TDataSet> // Increment / decrement
{
    [Fact]
...
//   6) d - 0 = d
//   7) d - d = 0
public partial class IDateQuickFacts<TDate, TDataSet> // Addition
{
    [Fact]
...
//   2) Symmetry
//   3) Transitivity
public partial class IDateQuickFacts<TDate, TDataSet> // IEquatable
{
    [Theory, MemberData(nameof(DateInfoData))]
...
//   2) Anti-symmetry
//   3) Transitivity
public partial class IDateQuickFacts<TDate, TDataSet> // IComparable
{
    [Fact]
