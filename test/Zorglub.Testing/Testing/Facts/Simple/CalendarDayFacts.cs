...
public partial class CalendarDayFacts<TDataSet> // Factories
{
    ...
    public void AtStartOfYear(YearInfo info)
    {
        ...
        // Act & Assert
        Assert.Equal(startOfYear, CalendarDay.AtStartOfYear(year));
    }
    ...
    public void AtDayOfYear(DateInfo info)
    {
        ...
        // Act & Assert
        Assert.Equal(exp, CalendarDay.AtDayOfYear(year, doy));
    }
    ...
    public void AtEndOfYear(YearInfo info)
    {
        ...
        // Act & Assert
        Assert.Equal(endOfYear, CalendarDay.AtEndOfYear(year));
    }
    ...
    public void AtDayOfMonth(DateInfo info)
    {
        ...
        // Act & Assert
        Assert.Equal(date, CalendarDay.AtDayOfMonth(month, d));
    }
    ...
    public void AtEndOfMonth(MonthInfo info)
    {
        ...
        // Act & Assert
        Assert.Equal(endOfMonth, CalendarDay.AtEndOfMonth(month));
    }
}
